              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    {errors.name_recipe && (
                      <p className="mt-1 text-sm text-red-600">{errors.name_recipe.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      {...register('servings', { required: 'Nombre de portions requis', min: 1 })}
                      type="number"
                      min="1"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500"
                    />
                ...
                <div>
                  ...
                  <textarea
                    {...register('instructions', { required: 'Instructions requises' })}
                    rows={5}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500"
