        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Vos données de compte</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Mettre à jour votre mot de passe</p>
            </div>
          </div>
      ...
      <div className="mt-8 bg-white rounded-lg shadow-sm border border-red-200 p-6">
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Actions irréversibles</p>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 bg-red-50 rounded-lg">
          <div>
          ...
          <button
            ...
            className="mt-3 sm:mt-0 sm:ml-4 flex items-center px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors"
          >
