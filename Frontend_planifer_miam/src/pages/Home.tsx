...
import { ChefHat, Calendar, Package, ShoppingCart, TrendingDown, Users } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-gray-900">MiamPlanner</span>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            MiamPlanner vous aide à organiser vos repas de la semaine, gérer votre stock alimentaire 
            et générer automatiquement vos listes de courses pour réduire le gaspillage.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-lg text-lg font-medium transition-colors shadow-lg"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Une solution complète pour organiser vos repas et optimiser vos achats alimentaires.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-emerald-100">Utilisateurs actifs</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">50k+</div>
              <div className="text-emerald-100">Repas planifiés</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">30%</div>
              <div className="text-emerald-100">Réduction du gaspillage moyen</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Rejoignez MiamPlanner aujourd'hui et transformez votre façon de cuisiner.
          </p>
          <Link
            to="/register"
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-lg text-lg font-medium transition-colors shadow-lg"
