...
import { Download, ShoppingCart, ChevronLeft, ChevronRight } from 'lucide-react';
...
const ShoppingList: React.FC = () => {
  ...
  const fetchShoppingList = async () => {
    try {
      setLoading(true);
      const data = await shoppingListAPI.generate(format(currentWeek, 'yyyy-MM-dd'));
  ...
  const handleDownload = async () => {
    try {
      const blob = await shoppingListAPI.download(format(currentWeek, 'yyyy-MM-dd'));
  ...
  const totalNeeded = shoppingList.reduce((sum, item) => sum + item.neededQuantity, 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Articles à acheter</h3>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 flex items-center px-3 py-1 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
              ...
              <div key={index} className="px-6 py-4 flex justify-between items-center hover:bg-gray-50 transition-colors">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    <span>Nécessaire: {item.totalQuantity} {item.unit}</span>
